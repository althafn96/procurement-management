...
var KTUser = (function () {
    ...
    var _handleUserSubmit = function () {
        var form = KTUtil.getById("kt_user_add_form");
        var formSubmitUrl = KTUtil.attr(form, "action");
        var formSubmitButton = KTUtil.getById("kt_user_add_btn");
        ...
        FormValidation.formValidation(form, {
            ...
            .on("core.form.valid", function () {
                ...
                var thisForm = document.getElementById("kt_user_add_form");
                $.ajax({
                    url: formSubmitUrl,
                    method: "POST",
                    dataType: "json",
    ...
    var _handleUserUpdate = function () {
        var form = KTUtil.getById("kt_user_update_form");
        var formSubmitUrl = KTUtil.attr(form, "action");
        var formSubmitButton = KTUtil.getById("kt_user_update_btn");
        ...
        FormValidation.formValidation(form, {
            ...
            .on("core.form.valid", function () {
                ...
                var thisForm = document.getElementById("kt_user_update_form");
                $.ajax({
                    url: formSubmitUrl,
                    method: "POST",
                    dataType: "json",
    ...
    var _handleUserRemove = function () {
        $("#kt_datatable").on("click", ".remove-btn", function () {
            var id = $(this).data("id");
            Swal.fire({
                title: "Are you sure?",
                text: "This will remove the User and related data",
                icon: "warning",
