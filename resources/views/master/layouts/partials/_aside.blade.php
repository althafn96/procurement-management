<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        <!--begin::Logo-->
        <a href="{{ url('/') }}" class="brand-logo d-flex">
            <img alt="Logo" src="{{ global_asset('assets/media/logos/logo-letter-9.png')}}" class="logo-default max-h-40px" />
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item {{ $title['menu'] == 'dashboard' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                <li class="menu-item {{ $title['menu'] == 'user-roles' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ url('/user-roles') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="menu-text">{{ __('User Roles') }}</span>
                    </a>
                </li>
                @endcan

                @can('view all staff')
                <li class="menu-item {{ $title['menu'] == 'staff' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                @can('view all plans')
                <li class="menu-item {{ $title['menu'] == 'plans' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{ route('plans.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">{{ __('Plans') }}</span>
                    </a>
                </li>
                @endcan

                @can('view all clients')
                <li class="menu-item {{ $title['menu'] == 'clients' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                <li class="menu-item {{ $title['menu'] == 'invoices' ? 'menu-item-active' : '' }}" aria-haspopup="true">
