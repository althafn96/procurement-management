            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-1 mr-5">Create Client</h5>
                        <!--end::Page Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <span class="text-muted">Create Client</span>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <button form="kt_client_add_form" id="kt_client_add_btn" type="submit" class="btn btn-sm btn-primary font-weight-bolder"><i class="ki ki-check icon-sm"></i>Save Client</button>
                </div>
                <!--end::Toolbar-->
            </div>
        </div>
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('clients.store') }}" class="form" id="kt_client_add_form">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-xl-8">
                                    <div class="my-5">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-solid" type="text" name="company" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control form-control-solid" type="text" name="id" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <h3 class="text-dark font-weight-bold mb-10 mt-10">Plan Info:</h3>
                                        <div class="form-group row">
                                                            ...
                                                            <label class="option">
                                                                <span class="option-control">
                                                                    <span class="radio radio-bold radio-brand">
                                                                        <input {{ $loop->first ? 'checked' : '' }}  type="radio" name="plan_id" value="{{ $plan->id }}">
                                                                        <span></span>
                                                                    </span>
                                                                </span>
