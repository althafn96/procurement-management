<x-app-layout :title="$title">
    ...
    <x-slot name="scripts">
        ...
        <script src="{{ asset('assets/master/js/pages/widgets.js') }}"></script>
    </x-slot>
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <h5 class="card-label">Dashboard</h5>
                    </div>
                    <!--end::Page Heading-->
                </div>
                <!--end::Info-->
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder text-dark">App Activity</span>
                                ...
                                <div class="timeline timeline-6 mt-3">
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <div class="font-weight-bolder text-dark-75 pl-3 font-size-lg">
                                            Added New Client - Company 2
                                            <br><span class="font-weight-normal text-muted ">Plan - Standard</span>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <div class="timeline-content d-flex">
                                            <span class="font-weight-bolder text-dark-75 pl-3 font-size-lg">Added Selina Kyle to Company 2

                                                <br><span class="font-weight-normal text-muted ">Desgination - CEO</span>
                                            </span>
                                        </div>
                                        <!--end::Content-->
                                    </div>
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <!--end::Badge-->
                                        <!--begin::Desc-->
                                        <div class="timeline-content font-weight-normal font-size-lg text-dark-75 pl-3 text-muted">Selina Kyle Logged in
                                        </div>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <!--end::Badge-->
                                        <!--begin::Desc-->
                                        <div class="timeline-content font-weight-bolder text-dark-75 pl-3 font-size-lg">Company 2 upgraded their plan to Premium
                                        </div>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <!--end::Badge-->
                                        <!--begin::Desc-->
                                        <div class="timeline-content font-weight-bolder text-dark-75 pl-3 font-size-lg">Company 1 upgraded their plan to Standard
                                        </div>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <!--end::Badge-->
                                        <!--begin::Desc-->
                                        <div class="timeline-content font-weight-normal font-size-lg text-dark-75 pl-3 text-muted">Login of staff Barry Allen disabled
                                        </div>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Item-->
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <!--begin::Content-->
                                        <div class="timeline-content d-flex">
                                            <span class="font-weight-bolder text-dark-75 pl-3 font-size-lg">Company 2 Login disabled

                                                <br><span class="font-weight-normal text-muted ">Payment Issues</span>
                                            </span>
                                        </div>
                                        <!--end::Content-->
                                    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                    ...
                                    <div class="d-flex flex-column text-right">
                                        ...
                                        <span class="text-muted font-weight-bold mt-2">New Clients</span>
                                    </div>
                                </div>
