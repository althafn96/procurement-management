<div id="kt_header" class="header header-fixed">
    ...
    <div class="container d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch mr-3">
            ...
            <div class="header-logo">
                <a href="dashboard.php">
                    <img alt="Ezy Proc Logo" src="{{ global_asset('assets/media/logos/logo-letter-9.png')}}"
                        class="logo-default max-h-40px" />
                    <img alt="Ezy Proc Logo" src="{{ global_asset('assets/media/logos/logo-letter-1.png')}}"
                        class="logo-sticky max-h-40px" />
                </a>
            </div>
            <!--end::Header Logo-->
            <!--begin::Header Menu Wrapper-->
            <div style="border: 0px solid #f00" class="header-menu-wrapper header-menu-wrapper-left"
                ...
                <div id="kt_header_menu"
                    ...
                    <!--begin::Header Nav-->
                    <ul class="menu-nav">
                        <li class="menu-item {{ $title['menu'] == 'dashboard' ? 'menu-item-here' : '' }} menu-item-rel">
                            <a href="{{ url('/' . tenant()->id) }}" class="menu-link">
                        ...
                        @if (auth()->user()->can('view all user roles') || auth()->user()->can('view all staff'))
                        <li class="menu-item {{ $title['menu'] == 'user-roles' ? 'menu-item-here' : '' }} {{ $title['menu'] == 'staff' ? 'menu-item-here' : '' }} menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item {{ $title['menu'] == 'user-roles' ? 'menu-item-here menu-item-open' : '' }} menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="{{url('/'.tenant()->id.'/user-roles')}}" class="menu-link">
                                    ...
                                    @endcan
                                    @can('view all staff')
                                    <li class="menu-item {{ $title['menu'] == 'staff' ? 'menu-item-here menu-item-open' : '' }} menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="{{ route('client-staff.index', [tenant()->id]) }}" class="menu-link">
                                            <span class="svg-icon menu-icon svg-icon-primary">
                        ...
                        @endif
                        @can('view all stakeholders')
                        <li class="menu-item {{ $title['menu'] == 'stakeholders' ? 'menu-item-here' : '' }} menu-item-rel">
                            <a href="{{ route('stakeholders.index', [tenant()->id]) }}" class="menu-link">
                                <span class="menu-text">Stakeholders</span>
                                <span class="menu-desc"></span>
                                <i class="menu-arrow"></i>
                            </a>
                        </li>
                        @endcan
                        @if (auth()->user()->can('view all opportunity requests') || auth()->user()->can('view all suppliers') || auth()->user()->can('view all categories'))
                        <li class="menu-item {{ $title['menu'] == 'opportunity-requests' ? 'menu-item-here' : '' }} {{ $title['menu'] == 'suppliers' ? 'menu-item-here' : '' }} {{ $title['menu'] == 'categories' ? 'menu-item-here' : '' }} {{ $title['menu'] == 'customers' ? 'menu-item-here' : '' }} {{ $title['menu'] == 'customer-organizations' ? 'menu-item-here' : '' }} menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="menu-text">Procurement Initiation</span>
                                <span class="menu-desc"></span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item {{ $title['menu'] == 'suppliers' ? 'menu-item-here menu-item-open' : '' }} menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="{{route('suppliers.index' , [tenant()->id])}}" class="menu-link">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Communication\Send.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <li class="menu-item {{ $title['menu'] == 'categories' ? 'menu-item-here menu-item-open' : '' }} menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="{{ route('categories.index', [tenant()->id]) }}" class="menu-link">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\General\Settings-1.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    @endcan
                                    @can('view all opportunity requests')
                                    <li class="menu-item {{ $title['menu'] == 'opportunity-requests' ? 'menu-item-here menu-item-open' : '' }} menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="{{ route('opportunity-requests.index', [tenant()->id]) }}" class="menu-link">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Communication\Dial-numbers.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            &nbsp;&nbsp;
                                            <span class="menu-text">Opportunity Requests</span>
                                        </a>
                                    </li>
                                    @endcan
                                </ul>
                        ...
                        @if (auth()->user()->can('view all pipelines') || auth()->user()->can('view all projects'))
                        <li class="menu-item {{ $title['menu'] == 'pipelines' ? 'menu-item-here' : '' }} {{ $title['menu'] == 'projects' ? 'menu-item-here' : '' }} menu-item-submenu menu-item-rel" data-menu-toggle="click"
                            aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item {{ $title['menu'] == 'projects' ? 'menu-item-here menu-item-open' : '' }} menu-item-submenu" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="{{ route('projects.index', tenant()->id) }}" class="menu-link">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Communication\Clipboard-list.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <li class="menu-item menu-item-submenu {{ $title['menu'] == 'pipelines' ? 'menu-item-here menu-item-open' : '' }}" data-menu-toggle="hover"
                                        aria-haspopup="true">
                                        <a href="{{ route('pipelines.index', [tenant()->id]) }}" class="menu-link">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Shopping\Barcode.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        @endif
                        @can('view all tasks')
                        <li class="menu-item {{ $title['menu'] == 'tasks' ? 'menu-item-here' : '' }} menu-item-rel">
                            <a href="{{ route('tasks.index', [tenant()->id]) }}" class="menu-link">
        ...
        <!--end::Left-->
        <!--begin::Topbar-->
        <div class="topbar" style="border: 0px solid #ff0">
            <!--begin::Search-->
            <div class="dropdown">
                <!--begin::Toggle-->
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        ...
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                            style="background-image: url({{ global_asset('assets/media/misc/bg-1.jpg')}})">
                            <!--begin::Title-->
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div
                        ...
                        <span
                            class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">{{ auth()->user()->full_name }}</span>
                        <span class="symbol symbol-35">
                            <span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">
                                {{ substr(auth()->user()->details->first_name,0,1) . substr(auth()->user()->details->last_name,0,1) }}
                            </span>
                        </span>
                    </div>
                </div>
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    ...
                    <div class="d-flex align-items-center p-8 rounded-top">
                        ...
                        <!--end::Symbol-->
                        <!--begin::Text-->
                        <div class="text-dark m-0 flex-grow-1 mr-3 font-size-h5">{{ auth()->user()->full_name }}</div>
