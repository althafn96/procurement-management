                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <a href="#" onclick="return false;" class="text-white text-hover-white opacity-75 hover-opacity-100">projects</a>
                            <!--end::Item-->
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">All Projects
                            </h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
                        <table
                        data-url="{{ route('projects.index', [tenant()->id]) }}"
                        data-view="{{ auth()->user()->can('view project') }}"
                        data-edit="{{ auth()->user()->can('edit project') }}"
                        data-remove="{{ auth()->user()->can('remove project') }}"
