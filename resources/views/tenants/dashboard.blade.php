<x-app-layout :title="$title">
    ...
    <x-slot name="styles">
        <link href="{{ global_asset('assets/tenants/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
    </x-slot>
    <x-slot name="scripts">
        ...
        <script src="{{ global_asset('assets/tenants/js/pages/widgets.js') }}"></script>
        <!--end::Page Scripts-->
    </x-slot>
