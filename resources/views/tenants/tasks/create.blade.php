                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <!--begin::Item-->
                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                            <a href="#" onclick="return false;" class="text-white text-hover-white opacity-75 hover-opacity-100">Create Task</a>
                            <!--end::Item-->
                        </div>
                        <!--end::Breadcrumb-->
                    </div>
                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            ...
                            <button form="kt_task_add_form" id="kt_task_add_btn" type="submit"
                                class="btn btn-sm btn-primary font-weight-bolder"><i class="ki ki-check icon-sm"></i>Save Task
                            </button>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('tasks.store', [tenant()->id]) }}" class="form" id="kt_task_add_form">
                            <div class="row">
