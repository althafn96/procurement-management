                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <a href="#" onclick="return false;" class="text-white text-hover-white opacity-75 hover-opacity-100">Organizations</a>
                            <!--end::Item-->
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">All Customer Organizations
                            </h3>
                        </div>
                        <div class="card-toolbar">
                            @if (auth()->user()->can('create customer organization'))
                                <a href="{{ route('customer-organizations.create', [tenant()->id]) }}" class="btn btn-primary font-weight-bold btn-sm create-btn"><i class="ki ki-plus icon-sm"></i>Create Organization</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin: Datatable-->
                        <table
                        data-url="{{ route('customer-organizations.index', [tenant()->id]) }}"
                        data-edit="{{ auth()->user()->can('edit customer organization') }}"
                        data-remove="{{ auth()->user()->can('remove customer organization') }}"
