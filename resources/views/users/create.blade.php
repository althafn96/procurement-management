    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                ...
                <button form="kt_user_add_form" id="kt_user_add_btn" type="submit" class="btn btn-sm btn-primary font-weight-bolder"><i class="ki ki-check icon-sm"></i>Save User</button>
            </div>
            <!--end::Toolbar-->
        </div>
    </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <!--begin::Form-->
                    <form method="POST" action="{{ route('staff.store') }}" class="form" id="kt_user_add_form">
                        <div class="row">
